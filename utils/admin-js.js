	...
	(function($) {
		...
		this.IPhoneCheckboxes = new Class({
			...
			options: {
				...
				elements: 'input[class=admincheckbox]'
			},
			...
			observe: function(el) {
				...
				var offLabel = new Element('span',{'class':this.options.labelOffClass,text:this.options.uncheckedLabel}).inject(wrap);
				var onLabel = new Element('span',{'class':this.options.labelOnClass,text:this.options.checkedLabel}).inject(wrap);
