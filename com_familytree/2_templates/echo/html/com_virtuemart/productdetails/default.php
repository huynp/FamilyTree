...
<div class="productdetails-view productdetails">
    ...
    <?php // Product Title   ?>
    <h1 id="CategoryProductTitle"><?php echo $this->product->category_name ?>
        : <?php echo $this->product->product_name ?> <?php echo $this->edit_link; ?></h2>
            ...
            <div class="span7 floatleft">
                ...
                if ($this->showRating) {
                    ...
                    if (empty($this->rating)) {
                        ...
                        ?>
                        <span class="vote">
	<?php echo JText::_('COM_VIRTUEMART_RATING') . ' ' . round($this->rating->rating) . '/' . $maxrating; ?> <span
                                title=" <?php echo(JText::_("COM_VIRTUEMART_RATING_TITLE") . round($this->rating->rating) . '/' . $maxrating) ?>"
                                class="ratingbox" style="display:inline-block;">
                    ...
                    if (VmConfig::get('ask_question', 1) == 1) {
                        ...
                        <div class="ask-a-question">
                            <a class="ask-a-question"
                               href="<?php echo $this->askquestion_url ?>"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_ENQUIRY_LBL') ?></a>
