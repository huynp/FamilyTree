...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
    ...
    <tr>
    	<td colspan="3">Thank you for your order. If you haven't already done so, you'll need to provide the family names that make up your family tree.<br /><br />Please go to <?php echo('<a href="/index.php?option=com_familytree&view=buildtrees&orderNumber='.$order->order_number.'&orderPass='.$order->order_pass.'">this page</a>');?>, fill out, and submit your family names.
        </td>
    </tr>
    <tr>
        <td colspan="3">
