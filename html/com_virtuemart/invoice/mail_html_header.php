...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
    ...
    <tr>
    	<td colspan="3">Thank you for your order. If you haven't already done so, you'll need to provide the family names that make up your tree.<br /><br />Please download, fill out, and then email your form to <b>order@customfamilytreeart.com</b> with your order number in the subject line of the email.
        </td>
    </tr>
    <tr>
        <td colspan="3">
