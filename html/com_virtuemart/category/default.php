...
<!--- Clint commented out to show after products instead of before, see below
...
<div class="orderby-displaynumber row-fluid">
	...
	<div class="span4 floatright display-number"><?php echo $this->vmPagination->getResultsCounter ();?><br/><?php echo $this->vmPagination->getLimitBox (); ?></div>
...
<h1 style="text-align:center; font-size:22px; padding-bottom:0px;"><?php echo $this->category->category_name; ?></h1>
    <?php
	 if(strpos($this->category->category_name, "Descendant") !== false) {
		echo "<center><div style='font-size:15px; font-weight:bold; padding-bottom:5px;'>Main couple or individual person on the trunk. Children, Grandchildren, Great-grandchildren as the branches.<br /><br />Start By Selecting A Print Type</div><center>"; 
	 }
	 else if(strpos($this->category->category_name, "Ancestor") !== false) {
	 	echo "<center><div style='font-size:15px; font-weight:bold; padding-bottom:5px;'>Main couple or individual person on the trunk. Parents, Grandparents, Great-grandparents as the branches.<br /><br />Start By Selecting A Print Type</div><center>"; 
	 }
	?>
	<?php
	// Category and Columns Counter
			...
			<div class="spacer" style="min-height:235px; min-width:100px; padding:10px">
				<div class="spacer-handler pr-img-handler">
					...
					<?php 
						...
						/*Clint Sorensen added if else statement that checks for Re-prints products to show them starting at $15.00*/
						if (strpos($productTitle,"Additional Prints") !== false) {
							echo '<div class="PricesalesPrice" style="display : block;"><span class="PricesalesPrice">$15.00+</span></div>';
						}
						else if (strpos($productTitle,"Updates") !== false) {
							echo '<div class="PricesalesPrice" style="display : block;"><span class="PricesalesPrice">$5.00+</span></div>';
						}
						else {
				...
				<h2 class="h-pr-title" style="min-height:52px;"><?php echo JHTML::link ($product->link, $product->product_name); ?></h2>

				<?php // Product Short Description
				if (!empty($product->product_s_desc)) {
					?>
					<!---Clint hide product description
